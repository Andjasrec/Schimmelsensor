  ...
  export default {
    ...
    methods: {
      ...
      registerUser: function() {
        ...
        const uri = "https://schimmelsensor_backend.ds.ava.hfg.design/api/register";
...
width: 43px;
height: 19px;
left: calc(50% - 43px/2 + 150px);
top: calc(50% - 19px/2 - 328.5px);
